...
class MongoCursor implements Iterator
{
    ...
    /**
     * @var \MongoDB\Driver\Cursor|null
     */
    public $mongoDBCursor = null;
     ...
     */
    public $mongoDBCollection = null;
//
//    public function setMongoDBCollection(\MongoDB\Collection $collection)
//    {
...
//    }
    ...
    public function __construct(
        MongoClient $client, $ns, array $query = [], array $fields = [],
        \MongoDB\Driver\Cursor $cursor = null,
        \MongoDB\Collection $collection = null
    )
    {
        $this->client = $client;
        ...
        $this->mongoDBCursor = $cursor;

        $this->iterator = new \IteratorIterator($this->mongoDBCursor);
        $this->mongoDBCollection = $collection;
...
//    {
//        try {
//            dump('count' . count($this->iterator));
//            return count($this->iterator);
//        }
//        catch (\Exception $e) {
//            dump('count_exception');
////            dump($this->next());
////            dump(iterator_count($this->iterator));
//            return count($this->iterator);
//        }
//
////        die(__METHOD__);
...
////        );
//
//        $response = $this->mongoDBCollection->find($this->query, [
//            'skip' => $this->querySkip
//        ])->toArray();
//
//        die();
...
//
////        $this->fetching = true;
////        $this->cursorId = md5(rand(1,10000000000)); //$response['cursorId'];
////        $this->setDocuments($this->mongoDBCursor->toArray());
//    }
//
...
//    {
//        die(__METHOD__);
////        if (false === is_null($this->iterator))
////        $this->doQuery();
...
//    public function current()
//    {
//        $result = (array)$this->iterator->current()->bsonSerialize();
